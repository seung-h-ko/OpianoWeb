    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className='w-full flex overflow-x-scroll snap-mandatory overflow-y-hidden snap-x z-10 scrollbar-thin
                 scrollbar-track-gray-400/20 scrollbar-thumb-[#ffe7b3]/80 scroll-smooth'>
            ...
            <div className='absolute left-[5%] bottom-1/2 text-[#ffe7b3] z-20'>
                ...
                >
                    <ChevronDoubleLeftIcon
                        className='h-10 w-10 active:scale-75 hidden sm:inline-block' />
                </Link>
            </div>
